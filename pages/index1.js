  ...
  rows: [
    {
      ...
      content: (
        <p>
          For an effective email marketing process, it is very important to
          verify the existence of an email address so as to acquire a new
          subscriber. For this, you invest lots of time and money to buy an
          email list from 3rd party vendors. But you are not sure whether these
          contact emails are authentic enough to deliver your marketing campaign
          or not. If you send email messages to fake email addresses, the
          bounce-back email ratio will increase and have a negative impact on
          your mail server’s reputation. That’s why identifying and removing
          invalid email addresses are essential to protect your email reputation
          and bounce-free email campaigns.
          <br />
          <br />
          By verifying email lists with our Email Extract Online tool, you can
          improve many of your options, such as:
          <ul>
            <li>• Open Rates</li>
            <li>• Bounce Rates</li>
    ...
    },
    {
      ...
      content: (
        <p>
          The Email Extract Online uses the most comprehensive database of
          public email addresses to find the correct contact information. All
          the email addresses go through an email verification process before
          being returned. The email addresses with a green shield mean they have
          been checked and found deliverable. You can use them safely and those
          email addresses with red shields are either unauthorized or are not in
          use.{" "}
        </p>
      ),
    },
    {
      ...
      content: (
        <p>
          Yes, with the bulk extraction feature, you can verify an unlimited
          number of emails within seconds.{" "}
        </p>
      ),
    },
    {
      title:
        "How protected are my emails, which I upload on your software, or do you share with any 3rd party?",
      content: (
        <p>
          It&quot;s 100% protected and safe. Any emails you upload into our
          software can only be accessed by you after login, and we don’t have
          any access to that as it gets stored in your storage.
        </p>
      ),
    },
  ],
  ...
  rows: [
    {
      ...
      content: (
        <p>
          It’s absolutely super-fast and quick, which extracts and verifies
          emails within seconds on your PC. Note: The performance and speed also
          depend on your PC as well.
        </p>
      ),
    },
    {
      ...
      content: (
        <ul className="listing-faq">
          <li>
            • <b>10</b> Total Domain Search
          </li>
          <li>
            • <b>10</b> Total Email Search
          </li>
          <li>
            • <b>10</b> Total Email Verification
          </li>
          <li>
            • <b>15000</b> Bulk Domain Search
          </li>
          <li>
            • <b>500</b> Bulk Domain Upload
          </li>
    ...
    },
    {
      ...
      content: (
        <p>
          If the Email Finder can&quot;t find the email address, we recommend
          you to verify the following elements:
          <ul className="listing-faq">
            <li>
              • Did you correctly enter the company or organization domain name
              for emails? In some cases, the domain name used for emails is
              different from the domain name used for the website.
            </li>
            <li>
              • Does the person you want to find still in the company or
              organization?
            </li>
          ...
          <p>
            <a>
              If the Email Finder is not able to find any result after verifying
              all these elements, you may be required to initiate a manual
              search
            </a>
          </p>
        </p>
    ...
    },
    {
      ...
      content: (
        <p>
          We started Email Extract Online because we found that other similar
          services were charging a lot of money for data that is either publicly
          available on the internet or not authorized. Our goal is to help YOU
          find suitable leads and build a million-dollar business, and to do
          that you need to save time and as much money as you can. We want to
          bring people together so that they can provide value for each other,
          and we plan on doing that by providing the best Email Extract Online
          tool ever.
        </p>
      ),
    },
...
export class index extends Component {
  ...
  handleSubmit = (e) => {
    ...
    this.setState({ allresponsedata: null,foundemails:"" });
  ...
  render() {
    return (
      <Body>
        <Head>
          <title>
            Email Extractors - Scrape Emails From Websites | Email Extract
            online
          </title>
          <meta
            name="description"
            content="Email Extract Online is a web-based software that can be used to scrape email addresses along with the phone numbers of potential clients just with the click of a button"
          />
          <meta
            name="keywords"
            content="email extractor online, email extractor from website, scrape emails from website, Scrape Email, online email extractor"
          />
        </Head>
        {/* 
                                =============================================
                ...
                <Animated isVisible={true}>
                  <div className="text-wrapper">
                    ...
                    <div className="title-style-five">
                      <h2>
                        <span>Grow Your Network</span> In Automation
                      </h2>
                    </div>
                    <p className="font-rubik">
                      From small businesses to FORTUNE 500** companies, over
                      150,000+ clients are using our quick and reliable Email
                      Extract Online tool to find, extract & build high-quality
                      leads from the internet in just one click.
                    </p>
                    <p className="font-rubik">
                      In short, it saves the hassle of collecting emails
                      manually by running this process automatically, thereby
                      providing you with a client database within seconds with
                      confidence scores, department filters and detailed
                      sources.
                    </p>
            ...
            <div className="title-style-five text-center mb-40 md-mb-40">
              <div className="row">
                <div className="col-lg-10 m-auto">
                  ...
                  <h6>
                    Find verified email of any targeted&nbsp;
        ...
        <div className="useable-tools-section-three mt-50 mb-80 md-mt-50 md-mb-80">
            ...
            <div className="row">
              <div className="col-lg-6">
                ...
                <p className="sub-text">
                  Email Extract Online is used by 1,000,000+ professionals and
          ...
          <div className="logo-wrapper d-flex flex-wrap justify-content-center align-items-center">
            <div className="logo d-flex align-items-center justify-content-center">
              <img src="images/cisco.png" alt="emailicon" className="w-75" />
            </div>
            <div className="logo d-flex align-items-center justify-content-center">
              <img src="images/ibm.png" alt="emailicon" className="w-75" />
            </div>
            <div className="logo d-flex align-items-center justify-content-center">
              <img src="images/ekwb.png" alt="emailicon" className="w-75" />
            </div>
            <div className="logo d-flex align-items-center justify-content-center">
              <img src="images/ipaydna.png" alt="emailicon" className="w-75" />
            </div>
            <div className="logo d-flex align-items-center justify-content-center">
              <img src="images/mcdonald.png" alt="emailicon" className="w-75" />
            </div>
            <div className="logo d-flex align-items-center justify-content-center">
              <img src="images/lorel.png" alt="emailicon" className="w-75" />
            </div>
              ...
              <Row>
                <Col sm={4}>
                  <div className="fancy-feature-nineteen-new-inner text-center">
                    ...
                    <p>
                      ...
                      We confirm that 99.5% of the data are correct.
                    </p>
                  </div>
                </Col>
                ...
                <Col sm={4}>
                  <div className="fancy-feature-nineteen-new-inner text-center">
                    ...
                    <p>
                      Contact us anytime, 24 hours * 7 days, to get the most
                      detailed answers to any of your questions.
                    </p>
                  </div>
                </Col>
                <Col sm={4}>
                  <div className="fancy-feature-nineteen-new-inner text-center">
                    ...
                    <h5>Free trial</h5>
                    <p>
                      Try any of the features of our tool for free before
                      purchasing.
                    </p>
                  </div>
                </Col>
              ...
              <Row className="mt-4">
                <Col sm={4}>
                  <div className="fancy-feature-nineteen-new-inner text-center">
                    ...
                    <h5>Malware free</h5>
                    <p>
                      Whenever you download and install our tool, we guarantee
                ...
                <Col sm={4}>
                  <div className="fancy-feature-nineteen-new-inner text-center">
                    ...
                    <p>
                      Though we are not a member of EU member states, yet all
                      our products and services are GDPR compliant.
                    </p>
                  </div>
                </Col>
                <Col sm={4}>
                  <div className="fancy-feature-nineteen-new-inner text-center">
                    ...
                    <p>
                      All of our products are highly recommended by the
                      professionals of small to large organizations.
                    </p>
                  </div>
                </Col>
              </Row>
            ...
            <div className="title-style-five text-center mb-20 md-mb-20">
              <div className="row">
                <div className="col-lg-7 col-md-9 m-auto">
                  ...
                  <h6>
                    What Our Client Say&nbsp;<span>About Us</span>
                  </h6>
                </div>
              </div>
            </div>
              ...
              <Slider {...settings}>
                <div className="item">
                  <div className="bg-wrapper">
                    <img
                      src="images/ipaydna.png"
                      alt="img-logo"
                      className="logo"
                    />
                    <p className="bg-wrapper-text-sec">
                      Absolutely love it! I would like to
                      <br /> say it is a brilliant tool for marketers like me. I
                      have tried a lot of other ones but only found lots of
                      problems, bugs, incorrect harvesting, constant blockages
                      by servers. Email Extract Online is well programmed and it
                      gets what you really need. Definitely recommend it!
                    </p>
                ...
                <div className="item">
                  <div className="bg-wrapper">
                    ...
                    <p className="bg-wrapper-text-sec">
                      ...
                      <br /> at Email Extract Online. I bought this tool 6
                      months ago and even after all this time when I reach out
                      for any help they are brilliant. So many online extracting
                      products promise the world and then fail to deliver - this
                      is a robust tool and a great bunch of people behind it.
                      Highly recommended.
                    </p>
                    <div className="text-section-testimonial">
                ...
                <div className="item">
                  <div className="bg-wrapper">
                    ...
                    />
                    <p className="bg-wrapper-text-sec">
                      My name is David, I tried Email
                      <br /> Extract Online and Email Bulk Finder and found both
                      of them to be very useful. The truth is unless you try
                      this tool, you will not know what you are missing out on.
                      I recommend the Email Extract Online tool to small and
                      large businesses - it is profitable especially when you
                      want to develop reasonable contacts and good relationships
                      with others.
                    </p>
                    <div className="text-section-testimonial">
                ...
                <div className="item">
                  <div className="bg-wrapper">
                    ...
                    <p className="bg-wrapper-text-sec">
                      Email Extract Online is very good
                      <br /> and many thanks to the developers for making such
                      an inexpensive tool. Very frankly, after using this tool,
                      I started seeing a big increase in my sales. In the past,
                      I tried many other resources as well as other email
                      harvesters to boost my sales but nothing was as effective
                      as your product. I found your product beyond my
                      expectations. Once again I thank you for making such an
                      effective product that really works.
                    </p>
                    <div className="text-section-testimonial">
                ...
                <div className="item">
                  <div className="bg-wrapper">
                    ...
                    <p className="bg-wrapper-text-sec">
                      ...
                      <br /> to extract emails of some prospective clients to
                      promote my services. Finally, I found it: Email Extract
                      Online. Today I am really pleased with the way this tool
                      works and the benefits, I get from email marketing.
                    </p>
                    <div className="text-section-testimonial">
                      <div className="name font-rubik">Johny Horoscope</div>
                ...
                <div className="item">
                  <div className="bg-wrapper">
                    <img
                      src="images/cybernetm.png"
                      alt="emailicon"
                      className="logo"
                    />
                    <p className="bg-wrapper-text-sec">
                      I bought the Email Extract Online
                      <br /> some time ago, it is so good that I felt like
                      sharing. Email Extract Online is a small investment that
                      can be made by any business but in a short period of time,
                      it can really bring profits for your business. It helps to
                      extract emails with superior potential for reaching good
                      customers. This software can be the best asset for any
        ...
        <div className="free-liveChart">
          <div className="container">
            ...
            <p>
              Supercharge your website and social media profiles. <br />
              Turn visits into sales, customers into fans.
            </p>
            <form className="w-75 free-liveChartForm">
              <Row>
                ...
                <Col sm={4}>
                  <Button
                    variant="primary"
                    className="btn-large w-100 btn-liveChat"
                    type="submit"
