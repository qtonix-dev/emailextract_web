...
export default class login extends Component {
  ...
  <div className="user-data-page clearfix d-lg-flex">
    <div className="illustration-wrapper d-flex align-items-center justify-content-between flex-column">
      <h3 className="font-rubik">Want your best managment <br />software? <a href="sign-up.html">sign up</a></h3>
    ...
    <div className="form-wrapper">
      ...
      <form onSubmit={this.handleSubmit} id="myForm" className="user-data-form mt-80 md-mt-40">
        <h2>Hi buddy, welcome <br /> Back!</h2>
        <p className="header-info pt-30 pb-50">Still don't have an account? <a href="sign-up.html">Sign up</a></p>
        <div className="row">
          ...
          <div className="col-12">
            <div className="input-group-meta mb-15">
              ...
              <input type="password" placeholder="Enter Password" className="" name="password" value={this.state.password} onChange={this.handleChange} />
