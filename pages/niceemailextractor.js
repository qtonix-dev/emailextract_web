...
export class niceemailextractor extends Component {
    ...
    handleSubmit=e=>{
        ...
        axios.get(`http://emailextractorgetinfo.ap-1.evennode.com/extract/${domainCreate[this.state.count].domain}`)
        .then(response=>{
    ...
    fetchRecord(){
        ...
        if(this.state.totaldomains===this.state.count){
            ...
            axios.get(`http://emailextractorgetinfo.ap-1.evennode.com/extract/${this.state.domainCreate[this.state.count].domain}`,{timeout:7000})
